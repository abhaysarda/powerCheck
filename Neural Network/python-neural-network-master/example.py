...
# Training set
dataset             = [ Instance( [0,0,0], [0] ), Instance( [0,0,1], [1] ), Instance( [0,1,0], [1] ), Instance( [0,1,1], [1] ),Instance( [1,0,0], [1] ), Instance( [1,0,1], [1] ), Instance( [1,1,0], [1] ), Instance( [1,1,1], [1] ) ]
...
Prediction Example
"""
prediction_set = [ Instance([0,1,1]), Instance([0,0,0]) ]
